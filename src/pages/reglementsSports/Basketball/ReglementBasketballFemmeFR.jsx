...
export default function ReglementBasketballFemmeFR() {
  return (
    <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'sans-serif', lineHeight: '1.6', color: '#333' }}>
      ...
      <p>4.1 Chaque équipe joue au moins trois (3) fois pendant le tournoi.</p>
      ...
      <ul>
        ...
        <li>Elle refuse de jouer malgré les injonctions de l’arbitre</li>
      </ul>
      <p>6.2 La rencontre est gagnée par l’équipe adverse par le score de dix à zéro (10 à 0). De plus, l’équipe déclarée forfait recevra 0 point au classement.</p>
      <p>6.3 La caution sera encaissée par le Comité Organisateur sans possibilité d’appel.</p>
      ...
      <p>8.1 Il y aura toujours des arbitres fédérés en fonction. En cas d’absence, les entraîneurs et le Comité d’organisation tenteront de trouver une personne apte à arbitrer.</p>
      <p>8.2 Toute décision de l’arbitre ne souffre d’aucune discussion. Toute sanction est sans appel. Seul le capitaine de l’équipe peut s’adresser à l’arbitre sur le terrain.</p>
      <p>8.3 Tout joueur (capitaine y compris) ou coach contestant directement les décisions de l’arbitre pendant le match ou adoptant un comportement incorrect (insulte...) est passible d’une expulsion sur le champ.</p>
      ...
      <p>9.2 L’équipe qui ne présente pas d’officiels recevra deux (2) sommations. Une lors de l’appel de match et une deuxième après 5minutes. Des arbitres de tables temporaires seront assignés pour permettre au match de commencer à l’heure. Après la deuxieme sommation (5min).</p>
      <p>9.3 La pénalité sur la caution sera appliquée dans ce cas de figure.</p>
      ...
      <p>12.1 Les équipes impliquées devront fournir un ballon de cuir officiel et les officiels choisiront le ballon de match. Pour les filles : # 6 et pour les garçons : # 7. Juniors moins de 11 ans #5.</p>
      ...
      <p>17.3 Un formulaire de décharge sera présenté aux capitaines et devra être signé par les joueurs si ce dernier n’a pas été signé lors de l’inscription individuelle.</p>
